...
class CoreDataStack {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "Photos", withExtension: "momd")! // type your database name here..
    ...
    static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: "Database error", code: 9999, userInfo: dict)
